    ...
    class ERE_Setup_Admin
    {
        ...
        public function menu_welcome_page_callback()
        {
            ...
            <div class="wrap about-wrap">
                <h1><?php echo sprintf( esc_html__( 'Welcome to Essential Real Estate %s', 'essential-real-estate' ), ERE_PLUGIN_VER) ?></h1>
        ...
        public function setup_page()
        {
            ...
            <div class="ere-setup-wrap">
                ...
                <?php if (1 === $step) : ?>
                    ...
                    <p><?php echo wp_kses_post( __('If you want to skip the wizard and setup the pages and shortcodes yourself manually, the process is still relatively simple. Refer to the <a href="http://document.g5plus.net/essential-real-estate">documentation</a> for help.', 'essential-real-estate')); ?></p>
